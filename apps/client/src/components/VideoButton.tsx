...
export function JoinCallButton() {
  ...
  return (
    <div ref={menuRef} className="fixed bottom-4 right-4 z-50 flex flex-col items-end space-y-2">
      {isExpanded && (
        <motion.div 
      ...
      <Tooltip content="" side="top">
        <motion.button
          ...
          animate={{
            boxShadow: ['0 10px 15px -3px rgba(16,185,129,0.2)', '0 15px 20px -3px rgba(16,185,129,0.3)', '0 10px 15px -3px rgba(16,185,129,0.2)'],
          }}
          transition={{
            boxShadow: {
              duration: 2,
