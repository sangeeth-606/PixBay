...
//   projectId: string;
//   onTaskAdded: () => void;
//   workspaceMembers?: User[]; // New prop for workspace members
// }
...
//   projectId,
//   onTaskAdded,
//   workspaceMembers = [], // Default to empty array
// }) => {
...
//   const [assigneeId, setAssigneeId] = useState(""); // New state for assignee
