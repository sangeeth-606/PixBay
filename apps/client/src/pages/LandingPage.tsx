...
const LandingPage = () => {
  ...
  return (
    <div className={`min-h-screen w-full ${darkMode ? 'bg-[#1C1C1C] text-white' : 'bg-[#F5F5F5] text-[#212121]'}`}>
      {/* Navigation */}
      <nav className={` sticky top-0 px-6 py-4 flex justify-between items-center border-b ${
        darkMode ? 'bg-[#171717] border-[#2C2C2C]' : 'bg-white border-gray-200'
      }`}>
        ...
        <div className="flex items-center space-x-6">
          ...
          <button 
            ...
            className={`p-2 rounded-full ${
              darkMode ? 'bg-[#2C2C2C] hover:bg-[#333]' : 'bg-gray-200 hover:bg-gray-300'
            } transition-colors`}
          >
  ...
  <span className="gradient-text">Pixbay </span>
          ...
          <p className={`text-lg md:text-xl mx-auto max-w-3xl mb-10 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            Create or join rooms, manage projects, and connect with one-click video meetings.
          </p>
    ...
    >
      ...
      >
        Close
          ...
          <div className={`relative mx-auto w-full max-w-4xl rounded-xl overflow-hidden border ${
            darkMode ? 'border-[#2C2C2C] bg-[#171717]' : 'border-gray-200 bg-white'
          }`}>
              ...
              <div className="w-full max-w-3xl p-4">
                ...
                <div className="flex w-full h-48 gap-4">
                  ...
                  <div className={`w-1/4 rounded-lg ${
                    ...
                    {[1, 2, 3, 4].map((item) => (
                      <div key={item} className={`w-full h-4 mb-2 rounded-md ${
                        darkMode ? 'bg-[#2C2C2C]' : 'bg-gray-200'
                      }`}></div>
                    ))}
                  </div>
                  ...
                  <div className={`flex-1 rounded-lg ${
                    ...
                    <div className="flex justify-between mb-3">
                      <div className={`w-1/3 h-6 rounded-md ${
                        darkMode ? 'bg-[#2C2C2C]' : 'bg-gray-200'
                      }`}></div>
                    ...
                    <div className="flex gap-2 h-32">
                      {[1, 2, 3].map((col) => (
                        <div key={col} className={`flex-1 rounded-md p-2 ${
                          darkMode ? 'bg-[#2C2C2C]' : 'bg-gray-200'
                        }`}>
                          <div className={`w-full h-4 mb-2 rounded-sm ${
                            darkMode ? 'bg-[#333]' : 'bg-gray-300'
                          }`}></div>
                          <div className={`w-full h-16 rounded-sm bg-emerald-500 bg-opacity-30`}></div>
                        </div>
                      ))}
                    </div>
                  </div>
      ...
      {/* Trusted By Section */}
      <section className={`py-12 ${darkMode ? 'bg-[#171717]' : 'bg-white'} border-y ${
        darkMode ? 'border-[#2C2C2C]' : 'border-gray-200'
      }`}>
        <div className="max-w-6xl mx-auto px-6 text-center">
          <p className={`text-sm mb-6 uppercase tracking-wide ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            Trusted by teams worldwide
          </p>
          <div className="flex flex-wrap justify-center gap-8 md:gap-16">
            {['Company A', 'Company B', 'Company C', 'Company D', 'Company E'].map((company, i) => (
              <div key={i} className={`text-lg font-medium ${darkMode ? 'text-gray-300' : 'text-gray-500'}`}>
                {company}
              </div>
            ))}
          </div>
      ...
      <section id="features" className="py-16 md:py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">Powerful Collaboration Features</h2>
          <p className={`text-center mx-auto max-w-3xl mb-16 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            Everything your team needs to work efficiently in one platform
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Feature 1 */}
            <div className={`rounded-xl p-6 ${darkMode ? 'bg-[#171717]' : 'bg-white shadow-md'} 
            transform transition-all hover:scale-105 border ${darkMode ? 'border-[#2C2C2C]' : 'border-gray-200'}`}>
              ...
              <p className={darkMode ? 'text-gray-400' : 'text-gray-600'}>
                Join video calls instantly with a single click – no setup required.
              </p>
            </div>
            ...
            transform transition-all hover:scale-105 border ${darkMode ? 'border-[#2C2C2C]' : 'border-gray-200'}`}>
              ...
              <p className={darkMode ? 'text-gray-400' : 'text-gray-600'}>
                Organize tasks with Kanban boards, timelines, and team assignments.
              </p>
            </div>
            ...
            transform transition-all hover:scale-105 border ${darkMode ? 'border-[#2C2C2C]' : 'border-gray-200'}`}>
              ...
              <p className={darkMode ? 'text-gray-400' : 'text-gray-600'}>
                Start a new workspace or jump into an existing one with a room code.
              </p>
            </div>
      ...
      <section id="projects" className={`py-16 md:py-24 px-6 ${darkMode ? 'bg-[#171717]' : 'bg-gray-100'} border-y ${
        darkMode ? 'border-[#2C2C2C]' : 'border-gray-200'
      }`}>
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">What You Can Build</h2>
          <p className={`text-center mx-auto max-w-3xl mb-16 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { title: 'Marketing Campaign', type: 'Marketing Project', color: 'emerald' },
              { title: 'Product Launch', type: 'Product Project', color: 'emerald' },
              { title: 'Development Sprint', type: 'Engineering Project', color: 'emerald' },
              { title: 'Content Calendar', type: 'Content Project', color: 'emerald' },
              { title: 'Research Study', type: 'Research Project', color: 'emerald' }
            ].map((project, i) => (
              <div 
                key={i} 
              ...
              >
                <div className={`h-40 bg-${project.color}-500 bg-opacity-20`}>
                  <div className="h-full flex items-center justify-center">
                    <div className={`h-20 w-20 rounded-xl bg-${project.color}-500`}></div>
                  </div>
                </div>
                <div className="p-6">
                  <div className={`text-sm rounded-full inline-block px-3 py-1 mb-2 ${
                  ...
                  <p className={`mb-4 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                    Collaborate with your team on this {project.type.toLowerCase()}.
                  </p>
                  <button 
                    className="bg-emerald-500 hover:bg-emerald-600 text-white py-2 px-4 rounded-md text-sm transition-colors"
                  >
                    Join Project
                  </button>
                </div>
      ...
      <section className="py-16 md:py-24 px-6 relative">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className={`mx-auto max-w-2xl mb-10 text-lg ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            Create a room or join your team in seconds. Experience the future of collaborative workspaces.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button className={`py-3 px-8 rounded-md font-medium text-lg transition-all transform hover:scale-105 ${
              darkMode ? 'bg-[#171717] hover:bg-[#2C2C2C] text-white border border-[#2C2C2C]' : 'bg-white hover:bg-gray-100 text-[#212121] border border-gray-300'
            }`}>
              Learn More
            </button>
          </div>
      ...
      {/* Footer */}
      <footer className={`py-12 px-6 ${darkMode ? 'bg-[#171717] border-t border-[#2C2C2C]' : 'bg-gray-100 border-t border-gray-200'}`}>
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            ...
            <div className="flex space-x-4">
              <a href="#" className={`${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-black'} transition-colors`}>About</a>
              <a href="#" className={`${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-black'} transition-colors`}>Features</a>
              <a href="#" className={`${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-black'} transition-colors`}>Support</a>
              <a href="#" className={`${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-black'} transition-colors`}>Contact</a>
            </div>
          </div>
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4">
              {[TwitterIcon, LinkedInIcon, GithubIcon, DiscordIcon].map((Icon, i) => (
                <a 
                  key={i} 
                  href="#" 
