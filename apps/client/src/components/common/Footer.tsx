...
const Footer: React.FC<FooterProps> = ({ darkMode }) => {
  return (
    <footer
      className={`py-12 px-6 bg-gradient-to-b from-[#0A0A0A] via-[#131516] to-[#0A0A0A]`}
    >
...
const DiscordIcon = () => (
  <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
    <path d="M20.317 4.37a19.791 19.791 0 00-4.885-1.515.074.074 0 00-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 00-5.487 0 12.64 12.64 0 00-.617-1.25.077.077 0 00-.079-.037A19.736 19.736 0 003.677 4.37a.07.07 0 00-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 00.031.057 19.9 19.9 0 005.993 3.03.078.078 0 00.084-.028c.462-.63.874-1.295 1.226-1.994a.076.076 0 00-.017-.078 10.012 10.012 0 01-1.85-6.007 10.012 10.012 0 011.85-6.007.076.076 0 00.017-.078c-.352-.699-.764-1.364-1.226-1.994a.078.078 0 00-.084-.028 19.9 19.9 0 00-5.993-3.03.082.082 0 00-.031-.057C.32 13.58-.533 9.046.317 4.397a.07.07 0 00.032-.027z"></path>
  </svg>
);
