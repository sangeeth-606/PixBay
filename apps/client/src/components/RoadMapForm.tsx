...
const RoadMapForm: FC<RoadMapFormProps> = ({
  ...
  <div className="fixed inset-0 z-50 overflow-y-auto">
    ...
    <div className="flex min-h-full items-center justify-center p-4 text-center">
      <div
        className={`w-full max-w-md transform overflow-hidden rounded-lg p-6 shadow-xl transition-all relative ${darkMode ? "bg-[#1C1C1C] text-white" : "bg-white text-gray-900"
          }`}
      >
        <h3
        ...
        <button
          type="button"
          className={`absolute top-3 right-3 ${darkMode
        ...
        {error && (
          <div
            className={`mt-4 p-3 rounded-lg flex items-center gap-2 ${darkMode
        ...
        >
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`mt-1 block w-full px-4 py-2.5 rounded-lg border-2 shadow-sm transition-all duration-200 ease-in-out ${darkMode
          ...
          <div className="mt-6 flex justify-end space-x-3">
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium text-white bg-emerald-500 border border-transparent rounded-md shadow-sm hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition duration-150 ease-in-out flex items-center justify-center min-w-[120px] ${!selectedProjectId || isLoading
